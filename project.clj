(defproject shadow-cljs-sass/lein-template "0.1.2"
  :description "Leiningen template providing a shadow cljs and sass project ready to go"
  :url "http://github.com/dazld/shadow-cljs-sass"
